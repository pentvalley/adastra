...
{
	CConfigurationTestDriver* l_pConfig=static_cast<CConfigurationTestDriver*>(pUserData);
...
CConfigurationTestDriver::CConfigurationTestDriver(IDriverContext& rDriverContext, const char* sGtkBuilderFileName)
	:CConfigurationBuilder(sGtkBuilderFileName)
	,m_rDriverContext(rDriverContext)
{
}

boolean CConfigurationTestDriver::preConfigure(void)
{
...
boolean CConfigurationTestDriver::postConfigure(void)
{
