function GazeEEG_createDataFilter(varargin)
...
% do nothing
% % if nargin > 0
    [Brainamp.Data.Params.FiltStruct.b,Brainamp.Data.Params.FiltStruct.a] = sos2tf(sos); % from second order structure to transfer function
    
    disp('Filter parameters');
    disp(Brainamp.Data.Params.samplingRate);
    disp(Brainamp.Data.Params.FiltStruct.a);
    disp(Brainamp.Data.Params.FiltStruct.b);
    
%     figure,
if feedback
    figure,
    freqz(conv(Brainamp.Data.Params.FiltStruct.b,fliplr(Brainamp.Data.Params.FiltStruct.b)), ...
        conv(Brainamp.Data.Params.FiltStruct.a,fliplr(Brainamp.Data.Params.FiltStruct.a)),[],Brainamp.Data.Params.samplingRate); % check filter response
end
