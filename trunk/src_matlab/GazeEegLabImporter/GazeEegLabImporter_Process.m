function NewEpochs = GazeEegLabImporter_Process(synchro_filename, EpochEventsStr, DisplayEventsStr, TimeInterval, StartFromTriggerStr, FilterData, NbNonEEGChan)
