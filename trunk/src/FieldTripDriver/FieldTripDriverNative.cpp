...
OpenViBE::boolean OpenViBEAcquisitionServer::FieldTripDriverNative::initialize(
	const uint32 ui32SampleCountPerSentBlock)//,IDriverCallback& rCallback)
{
...
//___________________________________________________________________//
//                                                                   //
OpenViBE::boolean OpenViBEAcquisitionServer::FieldTripDriverNative::isConfigurable(void)
{
...
//___________________________________________________________________//
//                                                                   //
OpenViBE::boolean OpenViBEAcquisitionServer::FieldTripDriverNative::requestHeader()
{
