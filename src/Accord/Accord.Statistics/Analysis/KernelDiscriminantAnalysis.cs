    ...
    public class KernelDiscriminantAnalysis : LinearDiscriminantAnalysis
    {
        ...
        public override void Compute()
        {
            ...
            if (gevd.IsSingular) // check validity of the results
                throw new Exception("One of the matrices is singular. Please retry " +
        ...
        {
            if (discriminants > DiscriminantMatrix.GetLength(1))
                throw new ArgumentException("The number of discriminant dimensions " +
                    "to use in the projection should be lower or equal to the " +
                    "total number of discriminants available.",
                    "discriminants");
