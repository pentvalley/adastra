...
EEG = pop_loadbv(gipsapath, eeg_filename);
EEG.setname='EegData';
...
%save data
global subject_name;
result_set_filename = [gipsapath subject_name '_channels_fp1_derivative_blink.set'];
